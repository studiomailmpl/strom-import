...
Skriv PRÆCIS som disse eksempler fra butikken:

- "Denne taske er fremstillet i en ruskinds læder. Den er designet med to sidelommer i hver side. Tasken har en strop der kan justeres. Indvendigt har tasken et stort rum og en mindre lomme med logo."
- "Disse sneakers er fremstillet i mesh og gummi. De har det klassiske Salomon logo på indvendig og udvendig. Disse sneakers lukkes og strammes med snøre."
...
FORMLEN:
1. "Denne [type] er fremstillet i [materiale]."
2. "Den er designet med [pasform/snit/detaljer]."
3. 1-2 sætninger mere om fysisk konstruktion (lommer, lukning, krave, ærmer osv.)
ALDRIG nævn: "fremgår ikke", "kan ikke udledes", "perfekt til", "ideel til", "elegant", "raffineret", "tidløs"
{description_examples}
